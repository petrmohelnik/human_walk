...
\projectinfo{
 ...
 % supervisor.title.a={},    %titul za jmenem (nepovinne)
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={skeletální animace, lidská chùze, inverzní kinematika}, %klicova slova v ceskem jazyce
  keywords.en={skeletal animation, human walk, inverse kinematics}, %klicova slova v anglickem jazyce
  %Abstract
