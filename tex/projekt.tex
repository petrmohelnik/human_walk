...
\projectinfo{
 ...
 % supervisor.title.a={},    %titul za jmenem (nepovinne)
  ...
  %Abstract
  abstract.cs={Animace lidské chùze má velké vyu¾ití v interaktivních aplikacích, pøevá¾nì poèítaèových hrách. Existuje mnoho zpùsobù tvorby této animace, které se li¹í v kompromisu mezi pøirozeností, kontrolou nad animací a výpoèetním èasem. Tato práce se zabývá implementací procedurální animace, která je vhodná pro chùzi po nerovném terénu. Pro manipulaci s modelem lidského tìla se vyu¾ívá skeletální animace. Dále je popsána a implementována inverzní kinematika, díky èemu mù¾e být animace pøizpùsobována pomocí parametrù. V práci jsou také popsány nìkteré existující implementace procedurální animace lidské chùze. A nechybí ani popis fází lidské chùze, abychom je mohli co nejvìrnìji napodobit.}, % abstrakt v ceskem jazyce
