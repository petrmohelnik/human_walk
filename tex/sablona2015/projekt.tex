...
\projectinfo{
  ...
  %Prohlaseni
  declaration={Prohlašuji, že jsem tento semestrální projekt vypracoval samostatně pod vedením Ing. Lukáše Poloka a uvedl jsem všechny zdroje, ze kterých jsem čerpal..},
  %Podekovani (nepovinne)
  acknowledgment={Děkuji svému vedoucímu práce Ing. Lukáši Polokovi za odbornou pomoc poskytnutou při řešení této práce.} % nepovinne
}
